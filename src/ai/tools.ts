...
const suggestProductsTool = tool({
  description:
...
const getMostLikedProductsTool = tool({
  description:
...
const searchProductsByTagsTool = tool({
  description:
...
const searchProductsByNameTool = tool({
...
export function getToolsWithoutCart(): ToolSet {
