...
export const onboardingSteps: Tour[] = [
  {
    ...
    steps: [
      ...
      },
      {
        ...
        content: <>Here you can see the latest products added to the store.</>,
      ...
      },
      {
        ...
        pointerPadding: 10,
        pointerRadius: 10,
        nextRoute: "/product/11111111-1111-1111-1111-111111111112",
        prevRoute: "/",
      },
      {
        icon: <>📇</>,
        ...
        pointerRadius: 10,
        nextRoute: "/product/11111111-1111-1111-1111-111111111112",
        prevRoute: "/product/11111111-1111-1111-1111-111111111112",
      },
      {
        icon: <>😍</>,
      ...
      },
      {
        ...
        selector: "#onboarding-tour-step-10",
        side: "bottom",
        showControls: true,
        pointerPadding: 10,
        pointerRadius: 10,
