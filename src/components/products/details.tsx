...
export function ProductDetails({ productUuid }: Readonly<{ productUuid: string }>): ReactNode {
const {data, isLoading, error} = useSWR<SWRResponse<ProductData>>(`${BASE_URL}/api/product/${productUuid}`, swrFetcher);
