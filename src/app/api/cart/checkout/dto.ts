...
export const checkoutResponseSchema = z.object({
  ...
  totalItems: z.number().int().min(0).describe("The total number of items in the order."),
  totalPrice: z.number().int().min(0).describe("The total price of the order in cents."),
